 ...
 * <br><br>
 * Chris Gonzalez Version 2.0 12/4/2016
 *
...
public class DateUtilities {
    ...
    /**
     * Returns the Duration between two LocalDateTime objects in minutes.
     *
     * @param startTime Starting LocalDateTime object
     * @param endTime Ending LocalDateTime object
     * @return Duration object representing difference between two LocalDateTime
     * objects
     * @throws IllegalArgumentException checks if any provided LocalDateTime
     * objects are null
     */
    public static Duration dateTimeDifferenceInMinutes(LocalDateTime startTime,
            LocalDateTime endTime) throws IllegalArgumentException {
        if (startTime == null || endTime == null) {
            throw new IllegalArgumentException("Only valid LocalDateTime "
                    + "objects accepted. ");
        }
        Duration difference = Duration.between(startTime, endTime);
        return Duration.ofMinutes(difference.toMinutes());
     ...
     *
     * @param dateTimeFormat format required in order to parse (Must use valid
     * symbols and patterns used by DateTimeFormatter)
     ...
     * LocalDate object
     *
     * @param dateFormat format required in order to parse (Must use valid
     * symbols and patterns used by DateTimeFormatter)
     * @param dateToParse Representation to be parsed
     * @return parsed LocalDate object
     * @throws IllegalArgumentException checks if provided LocalDate object is
     * null and if provided String for format is empty or null.
     */
    public static LocalDate toLocalDate(String dateFormat, String dateToParse) 
     ...
     * LocalTime object
     *
     * @param timeFormat format required in order to parse (Must use valid
     * symbols and patterns used by DateTimeFormatter)
     * @param timeToParse Representation to be parsed
     * @return parsed LocalTime object
     * @throws IllegalArgumentException checks if provided LocalTime object is
     * null and if provided String for format is empty or null.
     */
    public static LocalTime toLocalTime(String timeFormat, String timeToParse) 
            throws IllegalArgumentException {
     ...
     * @param localDateTimeFormat format to use for LocalDateTime provided (Must
     * use valid symbols and patterns used by DateTimeFormatter)
    ...
    /**
     * Changes a provided LocalDate object to a formatted String representation,
     * based on the format provided.
     *
     * @param localDate to be formatted
     * @param localDateFormat format to use for LocalDate provided (Must use
     * valid symbols and patterns used by DateTimeFormatter)
    ...
    /**
     * Changes a provided LocalTime object to a formatted String representation,
     * based on the format provided.
     *
     * @param localTime to be formatted
     * @param localTimeFormat format to use for LocalDate provided (Must use
     * valid symbols and patterns used by DateTimeFormatter)
    ...
    /* Prohibits instantiation -- In order to support the Singleton Design
    Pattern*/
    private DateUtilities() {
    }

    /**
     * This method that will make this DateUtilities class able to support the
     * Singleton Design Pattern
     *
     * @return the one and only global instance of a DateUtilities
     */
